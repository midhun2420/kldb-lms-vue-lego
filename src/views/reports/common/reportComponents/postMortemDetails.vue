    ...
    <div class="row">
        <div class="col-12 mt-3">
            <h3 class="text-primary fs-lg-4 font-poppins-semibold">
                Post-mortem Details of Individual Cow or Bull
            </h3>
        </div>
        <div class="col-12 mt-3">
            <s-form @submit="downloadReport" class="row">
                <div class="col-lg-2">
                            <validated-ajax-vue-select
                                ...
                                placeholder="Animal No"
                                v-model="model.regno"
                                label="Animal No"
                                :rules="{required:true}"
                                :url="animalOptionsURL"/>
                    </div>
                <div class="col-lg-2">
...
export default {
    ...
    data () {
        return {
            ...
            loading: false,
            animalOptionsURL: urls.reports.common.postMortemAnimals,
            reportTypeOptions: [
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.common.postMortemDetails, this.model);
