    ...
    <div class="row">
        <div class="col-12 mt-3">
            <h3 class="text-primary fs-lg-4 font-poppins-semibold">
                Culling Patterns Between two dates of male, female, regular bull, training bull
            </h3>
        </div>
        <div class="col-12 mt-3">
            <s-form @submit="downloadReport" class="row">
                <div class="col-lg-2">
                        ...
                        <validated-vue-select class="c-input-select field-required"
                                              :options="typeOptions"
                                              :rules="{required:true}"
                                              label="Animal Type" v-model="model.type"></validated-vue-select>

                </div>
                 <div class="col-lg-2">
                    <validated-date-picker v-model="model.from_date"
                                           label="From Date" :disabled-date="disabledAfterToday"
                                           :rules="{required:true}"
                ...
                <div class="col-lg-2">
                    <validated-date-picker v-model="model.to_date"
                                           label="To Date" :disabled-date="disabledAfterToday"
                                           :rules="{required:true}"
                                           class="c-input-datepicker field-required"
...
export default {
    name: 'cullingPatternBetweenTwoDates',
    watch: {
    ...
    data () {
        return {
            ...
            typeOptions: [
                ...
                { label: 'Cow', value: 'cow' },
                { label: 'Regular Bull', value: 'regular' },
                { label: 'Training Bull', value: 'training' }
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.common.cullingPatternBetweenTwoDates, this.model);
