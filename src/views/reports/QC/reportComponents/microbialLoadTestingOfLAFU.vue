    ...
    <div class="row">
        <div class="col-12 mt-3">
            <h3 class="text-primary fs-lg-4 font-poppins-semibold">
                MICROBIAL LOAD TESTING OF LAFU
            </h3>
        </div>
        <div class="col-12 mt-3">
...
export default {
    name: 'microbialLoadTestingOfLAFU',
    watch: {
    ...
    methods: {
        ...
        DateValidation (checkDate) {
            ...
            if (checkDateObj < fromDateObj) {
                return 'From Date should be greater than the To Date.';
            }
        ...
        FromDateValidation (checkDate) {
            ...
            if (checkDateObj > fromDateObj) {
                return 'From Date should be greater than the From Date.';
            }
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.qualityControl.microbialLoadTestingOfLAFU, this.model);
