    ...
    <div class="row">
        <div class="col-12 mt-3">
            <h3 class="text-primary fs-lg-4 font-poppins-semibold">
                Weight gain group wise, breed wise and source wise between two months
            </h3>
        </div>
        <div class="col-12 mt-3">
            <s-form @submit="downloadReport" class="row">
                ...
                <div class="col-lg-2">
                    <validated-ajax-vue-select :url="breedOptionsURL" multiple v-model="model.breed"
                                            label="Breed"
                                            class="c-input-select"/>
                </div>
                <div class="col-lg-2">
                    <validated-ajax-vue-select :url="groupOptionsURL" multiple v-model="model.group"
                                            label="Group"
                                            class="c-input-select"/>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-2">
                    <validated-select v-model="model.to_year" :options="yearOptions"
                                           label="To Year"
                                           class="c-input-select field-required" :rules="{required:true}" :error-message="toDateError"/>
                </div>
                <div class="col-lg-2">
...
export default {
    name: 'cowWeightGainIndividualBetweenTwoMonths',
    watch: {
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.cows.weightGainBreedSourceGroupBetweenTwoMonths, this.model);
