...
export default {
    ...
    methods: {
        ...
        async loadData () {
            this.loading = true;
            const response = await axios.get(urls.reports.cows.heiferReproductiveList + '?from_date=' + this.model.from_date);
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.cows.heiferReproductiveStatus, this.model);
