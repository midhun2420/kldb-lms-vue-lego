        ...
        <div class="col-12 mt-3">
            <s-form @submit="downloadReport">
                ...
                <div class="col-lg-2">
                 ...
                 <div class="row">
                    <div class="col-lg-2">
                        <validated-checkbox label="Calving" v-model="model.calving" default="false"/>
                    </div>
                    <div class="col-lg-2">
                        <validated-checkbox label="Abortion" v-model="model.abort" default="false"/>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.cows.calvedAbortedList, this.model);
