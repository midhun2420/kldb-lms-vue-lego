        ...
        <div class="col-12 mt-3">
            <s-form @submit="downloadReport" class="row">
                ...
                <div class="col-lg-2">
                    ...
                    label="Vaccinataion Type" class="c-input-select field-required" :rules="{required:true}" v-model="model.vaccination_type"/>
...
export default {
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.cows.cowIndividualVaccination, this.model);
