    ...
    <div class="row">
        <div class="col-12 mt-3">
            <h3 class="text-primary fs-lg-4 font-poppins-semibold">
                Individual Cow Calving / Abortion Details
            </h3>
        </div>
        <div class="col-12 mt-3">
...
export default {
    name: 'cowIndividualCalvingAbortion',
    data () {
        return {
            model: {
                cow: '',
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.cows.cowIndividualCalvingAbortion, this.model);
