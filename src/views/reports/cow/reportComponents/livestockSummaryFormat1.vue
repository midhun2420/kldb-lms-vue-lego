...
export default {
    ...
    data () {
        return {
            ...
            shedOptions: urls.reports.optionURLS.shedSelect + '?animal=cow',
            YesOrNoOptions: [
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.cows.livestockSummaryFormat1, this.model);
