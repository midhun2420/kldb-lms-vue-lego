    ...
    <div class="row">
        <div class="col-12 mt-3">
            <h3 class="text-primary fs-lg-4 font-poppins-semibold">
                Lactation summary cow wise between two dates lactation wise
            </h3>
        </div>
        <div class="col-12 mt-3">
...
export default {
        ...
        return {
            ...
            rules: {
                ...
                fromDay: {
                    required: true,
                    customValidator: (value) => {
                        return this.FromDayValidation(value);
                    }
                }
            }
        };
    ...
    methods: {
        ...
        FromDayValidation (checkday) {
            if (checkday) {
                if (checkday > 10) {
                    return 'Enter valid lactation number.';
                } else {
                    return true;
                }
            }
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.cows.lactationSummary, this.model);
