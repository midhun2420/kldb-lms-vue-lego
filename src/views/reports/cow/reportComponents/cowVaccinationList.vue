    ...
    <div class="row">
        ...
        <div class="col-12 mt-3">
            <s-form @submit="downloadReport" class="row">
                <div class="col-lg-2">
                    <validated-ajax-vue-select :url="shedOptionsURL" v-model="model.shed"
                                            label="Shed No"
                ...
                <div class="col-lg-2">
                    ...
                    :rules="{required:true}"
                    label="Vaccinataion Type" class="c-input-select field-required" v-model="model.vaccination_type"
                    />
...
export default {
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.cows.cowVaccinationList, this.model);
