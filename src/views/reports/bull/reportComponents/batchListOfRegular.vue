    ...
    <div class="row">
        <div class="col-12 mt-3">
            <h3 class="text-primary fs-lg-4 font-poppins-semibold">
                BATCH DETAILS  - Display the list of regular or training bull
            </h3>
        </div>
        <div class="col-12 mt-3">
...
export default {
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.bulls.batchListOfRegular, this.model);
