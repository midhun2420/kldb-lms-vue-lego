    ...
    <div class="row">
        ...
        <div class="col-12 mt-3">
            <s-form @submit="downloadReport" class="row">
                ...
                <div class="col-lg-2">
                    <validated-ajax-vue-select :url="shedOptionsURL" label="Shed No"
                                               placeholder="Shed"
                                                :rules="{required:true}"
                                               class="c-input-select text-black mb-0 field-required" v-model="model.shed"
                    />
                </div>
                <div class="col-lg-2">
...
export default {
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.bulls.shedWiseDeworming, this.model);
