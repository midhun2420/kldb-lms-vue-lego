    ...
    <div class="row">
        <div class="col-12 mt-3">
            <h3 class="text-primary fs-lg-4 font-poppins-semibold">
                Weight gain of different group in the month</h3>
        </div>
        <div class="col-12 mt-3">
...
export default {
    name: 'WeightGainOfDifferentGroup',
    data () {
        return {
            model: {
                month: '',
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.bulls.weightGainOfTwoGroup, this.model);
