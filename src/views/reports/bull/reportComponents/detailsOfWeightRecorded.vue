    ...
    <div class="row">
        <div class="col-12 mt-3">
            <h3 class="text-primary fs-lg-4 font-poppins-semibold">
                Details of weight recorded in the month and year (shed wise) </h3>
        </div>
        <div class="col-12 mt-3">
            <s-form @submit="downloadReport" class="row">
                <div class="col-lg-2">
                    <validated-select :options="monthOptions"
                ...
                <div class="col-lg-2">
                    <validated-select :options="yearOptions"
                                      class="c-input-select field-required"
                                      label="Year"
                                      :rules="{required:true}"
                                      v-model="model.year"/>
...
export default {
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.bulls.detailsOfWeightRecorded, this.model);
