    ...
    <div class="row">
        ...
        <div class="col-12 mt-3">
            <s-form @submit="downloadReport" class="row">
                ...
                <div class="col-lg-2">
                    <validated-ajax-vue-select :url="groupOptionsURL" label="Group"
                                               placeholder="Group"
...
export default {
    ...
    data () {
        return {
            ...
            groupOptionsURL: masterURLs.master.group.vueSelect,
            loading: false,
            reportTypeOptions: [
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.bulls.bullGroupWiseSemenStock, this.model);
