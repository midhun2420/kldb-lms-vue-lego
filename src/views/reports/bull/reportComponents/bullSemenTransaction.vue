    ...
    <div class="row">
        ...
        <div class="col-12 mt-3">
            <s-form @submit="downloadReport">
                <div class="row">
                     <div class="col-lg-2">
                    <validated-ajax-vue-select :url="bullOptionsURL" v-model="model.bull"
                                            label="Animal No"
...
export default {
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.bulls.bullSemenTransaction, this.model);
