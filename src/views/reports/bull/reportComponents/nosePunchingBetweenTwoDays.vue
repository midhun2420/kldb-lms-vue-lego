...
export default {
    name: 'nosePunchingBetweenTwoDays',
    watch: {
    ...
    methods: {
        ...
        //         const fromDateParts = fromDate.split('-');
        //
        //         const checkDay = parseInt(checkDateParts[0]);
        //         const checkMonth = parseInt(checkDateParts[1]);
        //         const checkYear = parseInt(checkDateParts[2]);
        //         const checkDateObj = new Date(checkYear, checkMonth - 1, checkDay);
        //
        //         const fromDateDay = parseInt(fromDateParts[0]);
        //         const fromDateMonth = parseInt(fromDateParts[1]);
        //         const fromDateYear = parseInt(fromDateParts[2]);
        //         const fromDateObj = new Date(fromDateYear, fromDateMonth - 1, fromDateDay);
        //
        //         if (checkDateObj <= fromDateObj) {
        //             return 'From Date is earlier than or equal to the To Date';
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.bulls.nosePunchingBetweenTwoDates, this.model);
