    ...
    <div class="row">
        ...
        <div class="col-12 mt-3">
            <s-form @submit="downloadReport" class="row">
                ...
                <div class="col-lg-2">
                    <validated-ajax-vue-select :url="breedOptionsURL" label="Breed" multiple
                                               placeholder="Breed"
                                               class="c-input-select text-black mb-0 field-required" v-model="model.breed"
                                               :rules="{required:true}"/>
                </div>
                <div class="col-lg-2">
                    <validated-ajax-vue-select :url="doseTypeOptionsURL" label="Dose Type"
                                               placeholder="Dose Type"
                                               class="c-input-select text-black mb-0 field-required" v-model="model.dose_type"
                                               :rules="{required:true}"/>
                </div>
                <div class="col-lg-2">
...
export default {
    ...
    data () {
        return {
            ...
            doseTypeOptionsURL: masterURLs.master.doseType.vueSelect,
            loading: false,
            reportTypeOptions: [
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.bulls.bullBreedWiseSemenStock, this.model);
