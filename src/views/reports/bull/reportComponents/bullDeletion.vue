        ...
        <div class="col-12 mt-3">
            <s-form @submit="downloadReport" class="row">
                ...
                <div class="col-lg-2">
                 ...
                 <div class="col-lg-2">
                    <validated-select :options="deletionTypeOptions"
                                      class="field-required c-input-select "
                                      label="Deletion Mode"
                                      :rules="{required:true}"
                                      v-model="model.deletion_type"/>
                </div>
                <div class="col-lg-2">
...
export default {
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.bulls.bullDeletion, this.model);
