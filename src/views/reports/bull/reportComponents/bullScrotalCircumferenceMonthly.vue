    ...
    <div class="row">
        <div class="col-12 mt-3">
            <h3 class="text-primary fs-lg-4 font-poppins-semibold">
                Scrotal Circumference Monthly Search
            </h3>
        </div>
        <div class="col-12 mt-3">
...
export default {
    name: 'bullScrotalCircumferenceMonthly',
    data () {
        return {
            model: {
                from_year: '',
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.bulls.bullScrotalCircumferenceMonthly, this.model);
