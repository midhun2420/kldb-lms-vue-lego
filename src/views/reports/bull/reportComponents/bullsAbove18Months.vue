            ...
            <s-form @submit="downloadReport" class="row">
                ...
                <div class="col-lg-2">
                    <validated-ajax-vue-select label="Registration Number"
                                               v-model="model.regno"
                                               :url="regNoOptionsURL"
                                               :rules="{required: isRegnoOrRenumberRequired}"
...
export default {
    ...
    data () {
        return {
            ...
            loading: false,
            regNoOptionsURL: urls.reports.bulls.regNoAbove18Months,
            renumberOptionsURL: urls.reports.bulls.renumberAbove18Months,
            reportTypeOptions: [
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.bulls.above18Months, this.model);
