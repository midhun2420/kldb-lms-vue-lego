    ...
    <div class="row">
        <div class="col-12 mt-3">
            <h3 class="text-primary fs-lg-4 font-poppins-semibold">
                SEMEN STOCK STATEMENT MONTH WISE FOR A PERIOD
            </h3>
        </div>
        <div class="col-12 mt-3">
            <s-form @submit="downloadReport" class="row">
                <div class="col-lg-2">
                    <validated-ajax-vue-select :url="breedOptionsURL" v-model="model.breed"
                                            label="Breed" multiple
                                               :rules="{required:true}"
...
export default {
    name: 'bullMonthlySemenStockForPeriod',
    watch: {
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.bulls.bullMonthlySemenStockPeriod, this.model);
