...
export default {
    ...
    data () {
        return {
            ...
            disposalReasonOptionsURL: urls.reports.optionURLS.semenDisposalReasonSelect,
            loading: false,
            reportTypeOptions: [
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.bulls.bullSemenDisposal, this.model);
