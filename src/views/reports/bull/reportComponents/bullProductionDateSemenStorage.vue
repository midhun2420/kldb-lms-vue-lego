    ...
    <div class="row">
        <div class="col-12 mt-3">
            <h3 class="text-primary fs-lg-4 font-poppins-semibold">
                PRODUCTION DATE WISE STORAGE SEARCH
            </h3>
        </div>
        <div class="col-12 mt-3">
            <s-form @submit="downloadReport" class="row">
                <div class="col-lg-2">
                    <validated-date-picker v-model="model.report_date"
                                           :rules="rules.reportdate"
...
export default {
    name: 'bullProductionDateSemenStorage',
    data () {
        return {
            model: {
                report_date: '',
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.bulls.bullsProductionDateSemenStorage, this.model);
