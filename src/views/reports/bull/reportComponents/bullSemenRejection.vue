            ...
            <s-form @submit="downloadReport" class="row">
                ...
                <div class="col-lg-2">
                    <validated-ajax-vue-select :url="bullOptionsURL" label="Animal No"
                                               ...
                                               class="c-input-select text-black mb-0" v-model="model.bull"
                                               />
                </div>
                <div class="col-lg-2">
...
export default {
    ...
    methods: {
        ...
        async downloadReport () {
            try {
                this.loading = true;
                const response = await axios.form(urls.reports.bulls.bullsSemenRejection, this.model);
