<template>
    <div class="container">
        <div class="mt-5 mb-2 fl-te-c card">
            <h4 class="text-primary mb-0 font-poppins-semibold">ABNORMALITY</h4>
            <div>
        ...
        <div class="card mt-2">
            <div class="row m-0">
                <div class="col-12">
                    <vue-table ref="table" :fields="fields" :url="listURL" :per-page="10" search-placeholder="Abnormality">
        ...
        <modal ref="addRegistrationType" :no-close-on-backdrop="true" title="Abnormality" :show-additional-buttons="true">
            <template #buttons>
            ...
            <s-form @submit="addEditItem">
                <div class="row">
                    <div class="col-lg-12">
                        <validated-input label="Abnormality" :rules="{required: true}"
                                         class="" border-radius="1" v-model="model.name"></validated-input>
                    </div>
                    <div class="col-lg-12">
                        <validated-vue-select label="Abnormality Type" :rules="{required: true}" :options="abnormalityOptions"
                                         class="" border-radius="1" v-model="model.abnormality_type"></validated-vue-select>
                    </div>
        ...
        <modal ref="editRegistrationType" :no-close-on-backdrop="true" title="Abnormality">
            <s-form @submit="addEditItem">
                <div class="row">
                    <div class="col-lg-12">
                        <validated-input label="Abnormality" :rules="{required: true}"
                    ...
                    <div class="col-lg-12">
                        <validated-vue-select label="Abnormality Type" :rules="{required: true}" :options="abnormalityOptions"
                                         class="" border-radius="1" v-model="editingItem.abnormality_type"></validated-vue-select>
                    </div>
                    <div class="col-12 text-right mt-4">
...
export default {
    ...
    data () {
        return {
            addEditURL: masterURLs.master.abnormality.addEdit,
            listURL: masterURLs.master.abnormality.list,
            deleteURL: masterURLs.master.abnormality.delete,
            itemID: null,
            addLoading: false,
            editLoading: false,
            editStatus: false,
            ...
            fields: [
                ...
                {
                    name: 'abnormality_type',
                    sortField: 'abnormality_type',
    ...
    methods: {
        async addEditItem () {
            try {
                ...
                if (result.success) {
                    if (this.editStatus) {
                        this.$notify('Abnormality Updated Successfully', 'Success', { type: 'success' });
                        this.editLoading = false;
                        this.editFormSuccess();
                    } else {
                        this.$notify('Abnormality Added Successfully', 'Success', { type: 'success' });
        ...
        addFormSuccess () {
            ...
            this.model.abnormality_type = null;
        ...
        editItem (item) {
            ...
            this.editingItem.abnormality_type = item.abnormality_type;
