<template>
    <div class="">
        <div class="mt-1 mb-2 fl-te-c card">
            <h4 class="text-primary mb-0 font-poppins-semibold">COUNTRY</h4>
            <div>
        ...
        <div class="card mt-2">
            <div class="row m-0">
                <div class="col-12">
                    <vue-table ref="table" :fields="fields" :url="listURL" :per-page="10" search-placeholder="Country">
        ...
        <modal ref="addRegistrationType" :no-close-on-backdrop="true" title="Country" :show-additional-buttons="true">
            <template #buttons>
            ...
            <s-form ref="form" @submit="addEditItem">
                <div class="row">
                    <div class="col-lg-12">
                        <validated-input label="Country" :rules="{required: true}"
        ...
        <modal ref="editRegistrationType" :no-close-on-backdrop="true" title="Country">
            <s-form ref="form" @submit="addEditItem">
                <div class="row">
                    <div class="col-lg-12">
                        <validated-input label="Country" :rules="{required: true}"
...
export default {
    ...
    data () {
        return {
            addEditURL: masterURLs.master.location.country.addEdit,
            listURL: masterURLs.master.location.country.list,
            deleteURL: masterURLs.master.location.country.delete,
            itemID: null,
            addLoading: false,
            editLoading: false,
            editStatus: false,
    ...
    methods: {
        async addEditItem () {
            try {
                ...
                if (result.success) {
                    if (this.editStatus) {
                        this.$notify('Country Updated Successfully', 'Success', { type: 'success' });
                        this.editLoading = false;
                        this.editFormSuccess();
                    } else {
                        this.$notify('Country Added Successfully', 'Success', { type: 'success' });
