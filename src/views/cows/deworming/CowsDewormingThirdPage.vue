                ...
                <div class="col-12">
                 ...
                 <div class="col-lg-2 mt-lg-5">
                    <validated-ajax-vue-select class="c-input-select input-border-primary" placeholder="Shed"
                                               v-model="shed_number" @input="loadCowOptions"
            ...
            <div class="row">
                ...
                <div class="col-7">
                    <div class="row px-lg-6">
                        <div class="col-lg-4">
                            <validated-input label="Animal"></validated-input>
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                            <validated-date-picker format="DD-MM-YYYY" label="Date of Birth" v-model="model.dob"></validated-date-picker>
                        </div>
                        <div class="col-lg-4">
