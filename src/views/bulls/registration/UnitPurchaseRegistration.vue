            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <validated-input type="text"
                                     label="Birth Weight" :rules="rules.decimalNumber"
                                     v-model="model.birthwt"></validated-input>
                </div>
                <div class="col-lg-2">
                    <validated-select :options="YesOrNoOptions"
                                      class="c-input-select field-required" :rules="{required:true}" label="F1 calf or not"
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <validated-ajax-vue-select class="c-input-select field-required"
                                               :url="shedOptionsURL"
                                               label="Shed No" v-model="model.shed_number_id" format="DD-MM-YYYY" :rules="{required:true}"></validated-ajax-vue-select>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-2">
                    <validated-date-picker :rules="rules.nosepunching"
                                           ...
                                           v-model="model.nosepunchdate"></validated-date-picker>
                </div>
                <div class="col-lg-2">
...
<!--                </div>-->
                ...
                <div class="col-lg-2">
                    <validated-input label="Dam’s Lactation Yield"  :rules="rules.positiveOnly"
                                     v-model="model.damlacyield" type="number"></validated-input>
                </div>
                <div class="col-lg-2">
...
<!--                </div>-->
                <div class="col-lg-2">
                    <validated-ajax-vue-select :url="breedOptionsURL"
                                               class="c-input-select field-required" :rules="{required:true}" label="Sire Breed"
                                               v-model="model.sirebreed"></validated-ajax-vue-select>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row" v-for="(vaccination, index) in model.vaccinations" :key="index">
                ...
                <div class="col-lg-2">
                    <validated-date-picker format="DD-MM-YYYY" :rules="rules.vaccinations" :key="index"
                                           class="c-input-datepicker" label="Vaccination Date"
...
<!--                </div>-->
                ...
                <div class="col-lg-2">
                    <validated-date-picker format="DD-MM-YYYY" v-model="model.transferdate"
                                           label="Transfer Date" class="c-input-datepicker field-required" :rules="rules.TransferDateValidation"></validated-date-picker>
                </div>
                <div class="col-lg-2">
